...
public class SubscriptionRefund {
        public SubscriptionRefund(PaymentPlan paymentPlan, BigDecimal requestedAmount, String refundReason, User requestedByUser) {
    ...
    // Support both Subscription and PaymentPlan for refunds
