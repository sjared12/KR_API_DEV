...
public class PaymentPlan {
    ...
    public String getSquareCardId() { return squareCardId; }
    public void setSquareCardId(String squareCardId) { this.squareCardId = squareCardId; }
}
