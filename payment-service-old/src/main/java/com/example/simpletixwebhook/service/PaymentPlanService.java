...
public class PaymentPlanService {
    /**
     * Get a payment plan by its ID
     */
    public Optional<PaymentPlan> getPlanById(Long planId) {
    ...
    public PaymentPlanService(PaymentPlanRepository repo, SquarePaymentService squarePaymentService) {
        this.repo = repo;
        this.squarePaymentService = squarePaymentService;
    }

    public SquarePaymentService getSquarePaymentService() {
